...
class Planner():
    ...
    def find_placement(self, target_box, target_index):
        ...
        print "target box is ", target_box
...
#        self.clearMilestones()
        ...
        self.check_points.append(end_T)
        l=vectorops.distance(current_T[1],end_T[1])
        #TODO this seems super arbitrary
        ...
        if not self.motion_milestones:
            raise RuntimeError("Can't find a feasible path to move item to inspection station")
