...
class EvaluatePinchGraspStow(EvaluatePinchGraspBase):
    '''
    Inputs:
    ...
    Outputs:
     - /photos/stow_tote/<camera>/pinch_grasps for all cameras viewing stow tote
     - /robot/target_photo_url set to /photos/stow_tote/<camera>/pinch_grasps for last camera viewing tote (HACK?)
...
if __name__ == '__main__':
    ...
    EvaluatePinchGraspStow(myname).run()
